...
I used SVM and computed the discriminant function <img src="https://render.githubusercontent.com/render/math?math=g(x) = \sum_{i=1}^{\tau_s} \alpha_id_iK(x_i,x) +">  <img src="https://render.githubusercontent.com/render/math?math= \theta"> 
